...
class LoggerConfig:
    ...
    def __init__(self, file_name: str = "logger", debug: bool = False, root_file = None):
        ...
        file_root = file_name if root_file is None else root_file
        self.__logger = logging.getLogger(file_root)
